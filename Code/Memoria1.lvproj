...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="NI-myRIO-1900-03050c88" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-03050c88</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Antiguo" Type="Folder">
			<Item Name="Step.vi" Type="VI" URL="../Step.vi"/>
			<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
			<Item Name="prueba2.vi" Type="VI" URL="../prueba2.vi"/>
			<Item Name="Step2 (SubVI).vi" Type="VI" URL="../Step2 (SubVI).vi"/>
			<Item Name="estesiquesi.vi" Type="VI" URL="../estesiquesi.vi"/>
			<Item Name="Homing.vi" Type="VI" URL="../Homing.vi"/>
			<Item Name="prueba.vi" Type="VI" URL="../prueba.vi"/>
			<Item Name="Prueba_Pt2Pt.vi" Type="VI" URL="../Prueba_Pt2Pt.vi"/>
			<Item Name="Step (SubVI)2.vi" Type="VI" URL="../Step (SubVI)2.vi"/>
			<Item Name="Calibrar.vi" Type="VI" URL="../Calibrar.vi"/>
			<Item Name="Mediciones.vi" Type="VI" URL="../Mediciones.vi"/>
			<Item Name="Mediciones2.vi" Type="VI" URL="../Mediciones2.vi"/>
			<Item Name="Mediciones3.vi" Type="VI" URL="../Mediciones3.vi"/>
			<Item Name="Mediciones4.vi" Type="VI" URL="../Mediciones4.vi"/>
		</Item>
		<Item Name="EjeX " Type="Folder">
			<Item Name="Main1.2.vi" Type="VI" URL="../Main1.2.vi"/>
			<Item Name="Calibrar(SubVI).vi" Type="VI" URL="../Calibrar(SubVI).vi"/>
			<Item Name="Homing2(SubVI).vi" Type="VI" URL="../Homing2(SubVI).vi"/>
		</Item>
		<Item Name="Globales.vi" Type="VI" URL="../Globales.vi"/>
		<Item Name="CallbackX.vi" Type="VI" URL="../CallbackX.vi"/>
		<Item Name="StepX (SubVI).vi" Type="VI" URL="../StepX (SubVI).vi"/>
		<Item Name="Main2.vi" Type="VI" URL="../Main2.vi"/>
		<Item Name="Calibrar2(SubVI).vi" Type="VI" URL="../Calibrar2(SubVI).vi"/>
		<Item Name="Homing3(SubVI).vi" Type="VI" URL="../Homing3(SubVI).vi"/>
		<Item Name="StepY (SubVI).vi" Type="VI" URL="../StepY (SubVI).vi"/>
		<Item Name="CallbackY.vi" Type="VI" URL="../CallbackY.vi"/>
		<Item Name="Control 2.ctl" Type="VI" URL="../Control 2.ctl"/>
		<Item Name="Mediciones4(SubVI).vi" Type="VI" URL="../Mediciones4(SubVI).vi"/>
		<Item Name="Prueba Sensor Digital.vi" Type="VI" URL="../Antiguo/Prueba Sensor Digital.vi"/>
		<Item Name="Untitled 1.vi" Type="VI" URL="../Antiguo/Untitled 1.vi"/>
		<Item Name="Prueba Antena.vi" Type="VI" URL="../Prueba Antena.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Step (SubVI).vi" Type="VI" URL="../Step (SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
